...
TEXTS = {
    "EN": {
        ...
        "files_panel_hint": "Reorder the list before renaming. The order here decides the final sequence.",
    ...
    "CZ": {
        ...
        "files_panel_hint": "Pred prejmenovanim si uprav poradi. Prave to urci vyslednou sekvenci.",
